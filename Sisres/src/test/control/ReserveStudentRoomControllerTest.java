...
public class ReserveStudentRoomControllerTest {
	...
	private static Vector<ReserveStudentRoom> vet;
	...
	public void testInserir() throws SQLException, ReserveException, ClientException, PatrimonyException {
		...
		String hora = "9:11";
		ReserveStudentRoom r = new ReserveStudentRoom(data, hora, sala1, finalidade, cadeiras_reservadas, aluno1);
	...
	public void testAlterar() throws ReserveException, SQLException, ClientException, PatrimonyException {
		...
		this.insert_into(r);
		vet.add(r);
		ReserveStudentRoom r2 = new ReserveStudentRoom(data, hora, sala1, finalidade, "100", aluno1);
	...
	public void testVetDia() throws SQLException, ReserveException, ClientException, PatrimonyException {
		...
		ReserveStudentRoom r = new ReserveStudentRoom("1/3/20", "9:11", sala1, "Room de Estudos", "60", aluno1);
		ReserveStudentRoom r2 = new ReserveStudentRoom("1/3/20", "9:11", sala1,"Room de Estudos", "30", aluno2);
		ReserveStudentRoom r3 = new ReserveStudentRoom("1/3/20", "10:00", sala1,"Room de Estudos", "120", aluno1);
		StudentDAO.getInstance().include(aluno2);
		this.insert_into(r);
		this.insert_into(r2);
		this.insert_into(r3);
		Vector<ReserveStudentRoom> vet2 = ReserveStudentRoomController.getInstance().getReserveMonth("1/3/20");
		this.delete_from(r);
		this.delete_from(r2);
		this.delete_from(r3);
		...
		Iterator<ReserveStudentRoom> it = vet2.iterator();
		while(it.hasNext()){
	...
	public void testVetDiaHoje() throws SQLException, ReserveException, ClientException, PatrimonyException {
		Student aluno2 = new Student("testInswewee", "490.491.781-20", "4324678", "", "");
		ReserveStudentRoom r = new ReserveStudentRoom("26/02/2013", "20:00", sala1, "Room de Estudos", "60", aluno1);
		ReserveStudentRoom r2 = new ReserveStudentRoom("26/02/2013", "20:00", sala1,"Room de Estudos", "30", aluno2);
		ReserveStudentRoom r3 = new ReserveStudentRoom("26/02/2013", "21:00", sala1,"Room de Estudos", "120", aluno1);
		StudentDAO.getInstance().include(aluno2);
		this.insert_into(r);
		this.insert_into(r2);
		this.insert_into(r3);
		Vector<ReserveStudentRoom> vet2 = ReserveStudentRoomController.getInstance().getReserveMonth("26/02/2013");
		this.delete_from(r);
		this.delete_from(r2);
		this.delete_from(r3);
		StudentDAO.getInstance().delete(aluno2);
	...
	private String where_reserva_sala_aluno(ReserveStudentRoom r){
		return " WHERE " +
	...
	private String values_reserva_sala_aluno(ReserveStudentRoom r){
