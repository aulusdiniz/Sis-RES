...
public class ResEquipamentoProfessorDAO extends DAO {
    ...
    private String select_id_equipamento(Equipament equipamento) {
        return "SELECT id_equipamento FROM equipamento WHERE " + "equipamento.codigo = \"" + equipamento.getCode() + "\" and "
    ...
    @SuppressWarnings("unchecked") public Vector<Object> buscarTodos() throws SQLException, ClienteException, PatrimonyException,
            ReservaException {
    ...
    @Override protected Object fetch(ResultSet rs) throws SQLException, ClienteException, PatrimonyException, ReservaException {
    ...
    private boolean equipamentoinDB(Equipament equipamento) throws SQLException {
    ...
    private boolean equipamentoinReservaDB(Equipament equipamento, String data, String hora) throws SQLException {
