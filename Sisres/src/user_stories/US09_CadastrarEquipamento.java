...
public class US09_CadastrarEquipamento {
    ...
    @Test public void testCenario1() throws SQLException, PatrimonyException {
        ...
        equipamento = EquipamentDAO.getInstance().searchAllEquipaments().get(index);
    }

    @Test public void testCenario2() throws SQLException, PatrimonyException {

        equipamento = new Equipament("code","Equipamento para testes de aceitacao");
        EquipamentDAO.getInstance().include(equipamento);
