...
public abstract class ReservaSalaView extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8088272317822624070L;
    ...
    abstract protected void studentRadioButtonAction();

    protected void getAluno() {
        try {

            Vector<Student> students = StudentController.getInstance().searchCpf(this.cpfTextField.getText());
            if (students.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Aluno nao Cadastrado." + " Digite o CPF correto ou cadastre o student desejado",
                        "Erro", JOptionPane.ERROR_MESSAGE, null);
                this.studentTextArea.setText("");
                this.student = null;
                return;
            }
            this.student = students.firstElement();
            this.studentTextArea.setText(student.toString());
    ...
    @SuppressWarnings("unchecked")// <editor-fold default state="collapsed"
        ...
        private void initComponents() {
                ...
                studentProfbuttonGroup = new javax.swing.ButtonGroup();
                ...
                studentLabel.setText("Aluno:");
                studentLabel.setName("AlunoLabel"); // NOI18N

                studentProfbuttonGroup.add(professorRadioButton);
                ...
                studentProfbuttonGroup.add(studentRadioButton);
                studentRadioButton.setText("Aluno");
                studentRadioButton.setName("studentRadioButton"); // NOI18N
                ...
                studentTextArea.setBackground(new java.awt.Color(200, 208, 254));
                studentTextArea.setColumns(20);
                studentTextArea.setRows(5);
                studentTextArea.setName("AlunoTextArea"); // NOI18N
    ...
    private void bucarCpfButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bucarCpfButtonActionPerformed
        ...
        private javax.swing.ButtonGroup studentProfbuttonGroup;
        protected javax.swing.JRadioButton studentRadioButton;
        protected javax.swing.JTextArea studentTextArea;
